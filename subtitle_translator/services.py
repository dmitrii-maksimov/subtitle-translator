...
class TranslationService:
    ...
    def build_prompt(self, group: List[srt.Subtitle], target_lang: str) -> str:
        ...
        extra_clause = ("\n- IMPORTANT: " + extra + " (this instruction is mandatory even if exact translation suffers)" if extra else "")
    ...
    def chat_infer_iso3(self, raw_lang: str) -> Union[str, Tuple[str, dict]]:
        ...
        user_msg = f"Language field: {raw_lang!r}. Return only ISO 639-2 code. {examples}"
        body = {
            "model": model,
            "messages": [
                {"role": "system", "content": system_msg},
